1. Input parameters (defined in JavaScript):
...
2. A corresponding webpage needs to be generated:
   ...
   * On the left side of the logo, there are two lines of text:
     ...
     * First line (main title): “Leaf Analyzer”, line height = 0.3 × al
     * Second line (subtitle): “APPN-Tech”, line height = 0.2 × al
   ...
   * Below TH is the pattern area, with a dashed border
