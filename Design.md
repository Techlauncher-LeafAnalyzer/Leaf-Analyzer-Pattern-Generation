...
2. A corresponding webpage needs to be generated:
   ...
   * Logo image width = height = 1.2 × al, centered horizontally, aligned to the top margin
   * QR code image placed to the right of the logo with a gap of 0.2 × al, aligned to the top margin, with width = height = 1.0 × al
